...
router.get('/stats', requireRole(['root', 'admin', 'manager', 'user']), getTrustStats);
...
router.post('/', requireRole(['root', 'admin', 'manager', 'user']), createTrust);

// PUT /api/trusts/:id - Actualizar fideicomiso
router.put('/:id', requireRole(['root', 'admin', 'manager', 'user']), updateTrust);
...
router.post('/:trustId/parties', requireRole(['root', 'admin', 'manager', 'user']), addTrustParty);

// PUT /api/trusts/:trustId/parties/:partyId - Actualizar parte
router.put('/:trustId/parties/:partyId', requireRole(['root', 'admin', 'manager', 'user']), updateTrustParty);
